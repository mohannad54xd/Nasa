...
onResize();
  ...
  // Create the Sun
  const sunTexture = textureLoader.load("/solar/textures/sun.jpg");
  ...
  const venusTexture = textureLoader.load("/solar/textures/venus.jpg");
  ...
  const jupiterTexture = textureLoader.load("/solar/textures/jupiter.jpg");
